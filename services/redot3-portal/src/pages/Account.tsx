        ...
        <Card className="bg-glass border-border/50">
          <CardContent className="p-6">
            <div className="text-center mb-6">
              ...
              <h1 className="text-lg font-semibold">Sign in to ABC-IO</h1>
              <p className="text-xs text-muted-foreground mt-1">
                Private account interface for the universal silicone and carbon cross-sensory platform.
              </p>
            </div>
